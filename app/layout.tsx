      ...
      <body className={inter.className + " "}>
        <header className="flex flex-col items-center justify-center bg-slate-800">
          <div className="flex flex-col md:mb-4 md:mt-8 md:flex-row justify-center items-center">
            <Image className="rounded-md mt-8 md:my-0 md:mx-4 w-18 h-18 md:w-28 md:h-28" width={100} height={100} src="/../public/headshot.png" alt="portrait"></Image>
            <Image className="mb-4 w-18 h-18 md:m-0 md:w-auto md:h-28 brightness-[1.1] saturate-[0.7] contrast-[1.1]" width={500} height={12} src="/../public/nameGraphic.png" alt="name"></Image>
          </div>
