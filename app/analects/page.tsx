  ...
  return (
    <div className="flex h-screen">
      ...
      <ListDrawer
        ...
        side="left"
      />
      <div className="w-full py-32 md:p-8 flex flex-col overflow-scroll">
        {!activeDocument && <p className="w-full h-full flex items-center justify-center text-gray-700 italic">Select an analect</p>}
        <h1 className="text-center text-lg my-8 font-bold">{(activeDocument && currentLanguage) ? activeDocument[currentLanguage]?.title : ""}</h1>
